...
[![My Skills](https://skillicons.dev/icons?i=vscode,git,html,css,js,figma,firebase,jest,nodejs,postman,vite,react,bootstrap,tailwind,sqlite,mysql,py,wordpress,java,postgres,spring,docker,ubuntu,vue,ts,php,symfony,androidstudio&theme=dark)](https://skillicons.dev)
<!--
